...
function porcentajeCo2($val){
    //$val= 0.9;
    if($val >= 0 && $val <= 100){
        // Restar 2 al val, pero si es menor a 2, entonces mostrar 0
        $valor = max(0, $val - 2);
    } else {
        $valor = "NA";
    }
...
function evaluarEstado($dato){
    //comparar $dato con la fecha actual, es Online si la diferencia no es mayor a 30 minutos, wait es es mayor a 30 minutos y menor a 12 horas, offline si es mayor a 12 horas
...
function ContenedorMadurador_2($val, $url=0){ 
    ...
    $cargo_4_temp_f = evl_usda($val->cargo_4_temp);
    ...
    $co2_pr = porcentajeCo2($val->co2_reading);
            ...
            <div class='card'>
                    <div class='card-body'>
                        <div class='d-flex justify-content-center'>
                            <img src='{$imagenPrincipal}' alt='Contenedor' class='img_contenedor'>
                        </div>
                    ...
                    <!--SEEEEEEEEEEEEET POOOOOOOOOOOOOOOOOINNNNNNNNNNNNNT-->
                    <div class='col-6 col-lg-3 border-top'>
                        <div class='text-center'>
                            <!-- ICON SET POINT-->
                        ...
                        <div class='row'>
                            <div class='col-12 col-lg-6 mt-1'>
                                <div class='card'>
                                    <div class='card-body'>
                                        <h5>Genset 1</h5>
                                        <div class='col-12 row align-items-center mt-1'>
                                            <div class='col-12 col-lg-6'>
                                                <label>Estado</label>   
                                            </div>
                                            <div class='col-12 col-lg-6'>
                                                <input type='text' id='estadoGenset1' class='form-control text-center' value='ON' readonly>
                                            </div>
                                        </div>
                                        <div class='col-12 row align-items-center mt-1'>
                                            <div class='col-12 col-lg-6'>
                                            ...
                                            <div class='col-12 col-lg-6'>
                                                <input type='text' id='horometroGenset1' class='form-control text-center' value='357' readonly>
                                            </div>
                                        </div>
                                        <div class='col-12 row align-items-center mt-1'>
                                            <div class='col-12 col-lg-6'>
                                            ...
                                            <div class='col-12 col-lg-6'>
                                                <input type='text' id='waterTmpGenset1' class='form-control text-center' value='76 °C' readonly>
                                            </div>
                                        </div>
                                        <div class='col-12 row align-items-center mt-1'>
                                            <div class='col-12 col-lg-6'>
                                            ...
                                            <div class='col-12 col-lg-6'>
                                                <input type='text' id='voltajeGenset1' class='form-control text-center' value='316 V' readonly>
                                            </div>
                                        </div>
                                        <div class='col-12 row align-items-center mt-1 hidden-content-genset1' id='nvlComb'>
                                            <div class='col-12 col-lg-6'>
                                                <label>Nivel de Combustible</label>   
                                            </div>
                                            <div class='col-12 col-lg-6'>
                                                <input type='text' id='nCombGenset1' class='form-control text-center' value='comb' readonly>
                                            </div>
                                        </div>
                                        <div class='col-12 row align-items-center mt-1 hidden-content-genset1' id='cmp1'>
                                            <div class='col-12 col-lg-6'>
                                                <label>1</label>   
                                            </div>
                                            <div class='col-12 col-lg-6'>
                                                <input type='text' id='1Genset1' class='form-control text-center' value='1' readonly>
                                            </div>
                                        </div>
                                        <div class='col-12 row align-items-center mt-1 hidden-content-genset1' id='cmp2'>
                                            <div class='col-12 col-lg-6'>
                                                <label>2</label>   
                                            </div>
                                            <div class='col-12 col-lg-6'>
                                                <input type='text' id='2Genset1' class='form-control text-center' value='2' readonly>
                                            </div>
                                        </div>
                                        <div class='col-12 row align-items-center mt-1 hidden-content-genset1' id='cmp3'>
                                            <div class='col-12 col-lg-6'>
                                                <label>3</label>   
                                            </div>
                                            <div class='col-12 col-lg-6'>
                                                <input type='text' id='3Genset1' class='form-control text-center' value='3' readonly>
                                            </div>
                                        </div>
                                        <div class='col-12 row align-items-center mt-1 hidden-content-genset1' id='cmp4'>
                                            <div class='col-12 col-lg-6'>
                                                <label>4</label>   
                                            </div>
                                            <div class='col-12 col-lg-6'>
                                                <input type='text' id='4Genset1' class='form-control text-center' value='4' readonly>
                                            </div>
                                        </div>
                                        <div class='col-12 row align-items-center mt-1 hidden-content-genset1' id='cmp5'>
                                            <div class='col-12 col-lg-6'>
                                                <label>5</label>   
                                            </div>
                                            <div class='col-12 col-lg-6'>
                                                <input type='text' id='5Genset1' class='form-control text-center' value='5' readonly>
                                            </div>
                                        </div>
                                        <!--view more /less in the center -->
                                        <div class='col-12 row align-items-center mt-1'>
                                            <div class='col-12 text-center' id='viewG'>
                                                <button type='button' class='btn btn-primary btn-sm view-more-genset1' onclick='viewMoreG()'>View More</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class='card'>
                                    <div class='card-body'>
                                        ...
                                        <div class='col-12 row align-items-center mt-1'>
                                            ...
                                            <div class='col-12 col-lg-6'>
                                                <input type='text' id='estadoGenset2' class='form-control text-center' value='OFF' readonly>
                                            </div>
                                        </div>
                                        <div class='col-12 row align-items-center mt-1'>
                                            <div class='col-12 col-lg-6'>
                                            ...
                                            <div class='col-12 col-lg-6'>
                                                <input type='text' id='horometroGenset2' class='form-control text-center' value='170' readonly>
                                            </div>
                                        </div>
                                    </div>
                                </div>
